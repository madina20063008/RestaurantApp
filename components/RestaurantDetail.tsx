...
//   const { t } = useLanguage();
//   const { addToCart, cartItems, getItemQuantity, getCartTotal } = useCart();
...
//             <Text style={styles.metaText}>{restaurant.time || '25-30'} {t('min')}</Text>
//           </View>
...
//             // onPress={() => navigate('cart')} // Uncomment when you have cart screen
//           >
//             <View style={styles.cartInfo}>
//               <ShoppingBag size={20} color="#FFFFFF" />
//               <Text style={styles.cartItemsText}>
//                 {restaurantCartItems.reduce((sum, item) => sum + item.quantity, 0)} items
//               </Text>
//             </View>
...
import { ChevronLeft, Star, Clock, MapPin, ShoppingBag, Plus, Minus } from 'lucide-react-native';
